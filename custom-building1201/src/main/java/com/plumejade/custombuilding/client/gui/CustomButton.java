...
public class CustomButton extends ExtendedButton {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CustomBuilding.MODID, "textures/gui/prefab_button.png");
    private static final ResourceLocation TEXTURE_HOVER =
            new ResourceLocation(CustomBuilding.MODID, "textures/gui/prefab_button_highlight.png");
