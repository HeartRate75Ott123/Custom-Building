 ...
 * "remember the last orientation" should mean.  It is a {@link ModConfig.Type#CLIENT} config, so it is only
 * loaded on the client; every accessor here is safe to call from either side.</p>
 */
public final class ClientPreferences {
    private static final ModConfigSpec.Builder BUILDER = new ModConfigSpec.Builder();

    public static final ModConfigSpec.ConfigValue<String> LAST_FACING = BUILDER
